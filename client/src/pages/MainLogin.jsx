        ...
        <div className="flex flex-col">
          ...
          <div className="flex justify-center gap-2 w-80">
            <a
              ...
              className="underline text-[12px] mt-3"
            >
              Forgot Password?
            </a>
          </div>
          ...
          <div className="flex flex-col justify-center items-center w-80 mt-5">
            ...
            <div className="flex gap-5">
              ...
              <a href="http://www.youtube.com">
                <img src={microsoft} alt="" className="cursor-pointer" />
              </a>
            </div>
          </div>
          <div>
            {Error && <p className="text-red-600 mt-3 text-[14px] font-semibold"> please fill in your email and password to proceed</p>}
          </div>
